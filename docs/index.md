...
- `cardano_amaru_epoch240/`: An Antithesis-only long-epoch variant of `cardano_amaru` for one-hour campaigns that can cover enough simulated time for two complete 240-slot Conway epochs.
