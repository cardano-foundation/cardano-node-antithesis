...
const config: Config = {
  ...
  url: process.env.CARDANO_NODE_ANTITHESIS_SITE_URL ?? 'https://cardano-foundation.github.io/',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: process.env.CARDANO_NODE_ANTITHESIS_SITE_BASE_URL ?? '/cardano-node-antithesis',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'cardano-foundation', // Usually your GitHub org/user name.
  projectName: 'cardano-node-antithesis', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/cardano-foundation/cardano-node-antithesis/tree/main/docs/',
        },
        blog: {
          routeBasePath: '/blog',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/cardano-foundation/cardano-node-antithesis',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    prism: {
      ...
      id: 'support_us',
      content:
          '<strong>cardano-node-antithesis is still at an early stage and experimental. Contributions and ideas are <a target="_blank" rel="noopener noreferrer" href="https://github.com/cardano-foundation/cardano-node-antithesis/">most welcome</a></strong>',
