...
| run-report honesty | pipeline → per-property report → desk | missing/failed/partial run is loudly RED; verdicts complete | NONE — E-A deliverable; missing-run red proven by seeded skip |
