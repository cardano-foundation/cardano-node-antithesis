...
and tmux-orchestrator only for acknowledged immediate-owner pointer transport.
The desk performs asks, answers, and sweeps; never implement or address an
epic's ticket owners or workers.
