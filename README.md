...
- `cardano_amaru_epoch360`: Antithesis-only variant of `cardano_amaru` with 360-slot epochs. It is for one-hour Antithesis campaigns where simulated time is long enough for two complete epochs; it is not part of the default wall-clock smoke-test matrix.
